...
import {Profile,Item, Create,Login,SuuplierRegister,Supplier, SupplierMyAddon, SupplierMySales, SupplierVerifcation} from './pages'
    ...
    <div>
      <Navbar />
          <Routes>
            ...
            <Route path="/supplier/accounts" element={ <SupplierVerifcation />} />
          </Routes>
      <Footer />
    </div>
  );
